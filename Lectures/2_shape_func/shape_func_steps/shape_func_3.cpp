...
// Changes from shape_func_2.cpp:
// validate each substring to be "? = numerical values" with finding equal-sign and stod()
// try to add additional line "r = abcd" to your input.txt to test

// This is shape_func_3.cpp
// Changes compared to shape_func_2.cpp:
// - Validates each substring by finding an equals sign and converting the number with std::stod.
// - Reports an invalid number when conversion fails.
// Add r = abcd to input.txt to test the conversion error.

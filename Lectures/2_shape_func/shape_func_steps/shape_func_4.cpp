...
// Changes compared to shape_func_3.cpp:
// - Verifies each parsed number is valid for the selected shape.
// - Calculates area based on the number of values found in the input line.

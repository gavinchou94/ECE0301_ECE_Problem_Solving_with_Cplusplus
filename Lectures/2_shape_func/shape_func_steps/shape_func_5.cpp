// This is shape_func_5.cpp
// Changes compared to shape_func_4.cpp:
// - Extracts the try-catch conversion block into a function.
// - Adds the function prototype near the beginning of the file.

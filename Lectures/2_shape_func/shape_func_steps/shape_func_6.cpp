...
// Changes compared to shape_func_5.cpp:
// - Extracts the area calculations into overloaded functions.
// - Adds function prototypes near the beginning of the file.
// - Uses identical function names with different parameter lists.

// This is test_pointers_7.cpp
// Changes from test_pointers_6.cpp: (OPTIONAL TO STUDY)
// 1. add supplement verification of REVEL chapter 9.9
// 2. ptr returning from dynamic array is valid outside function scope, static one invalid
#define CATCH_CONFIG_MAIN

#include <iostream>

#include "catch.hpp"
#include "pointers_7.hpp"

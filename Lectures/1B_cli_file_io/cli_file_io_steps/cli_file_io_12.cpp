// You may notice an output_11.txt is generated, but with blank content

// This is cli_file_io_12.cpp
// Changes from cli_file_io_11.cpp:
...
int main()
{
  ...
  file_read.close();  // close the input file object
  file_write.close(); // close the output file object
  return EXIT_SUCCESS;
}
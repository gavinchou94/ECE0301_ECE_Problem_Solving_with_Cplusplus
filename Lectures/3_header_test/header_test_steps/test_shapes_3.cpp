...
// Changes compared to test_shapes_2.cpp:
// - Tests passing by value and passing by reference.
// - Uses std::cout inside and outside the functions to show the difference.
// - Tests the function with a default argument.

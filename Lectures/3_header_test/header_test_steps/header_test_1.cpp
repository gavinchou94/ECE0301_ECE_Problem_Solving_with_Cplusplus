// This is header_test_1.cpp
// Changes from header_test_starter.cpp:
// 1. move all function prototypes and function bodies to .hpp file
// 2. include .hpp as a header
...
#include "shapes_1.hpp" // or shapes_2.hpp ...

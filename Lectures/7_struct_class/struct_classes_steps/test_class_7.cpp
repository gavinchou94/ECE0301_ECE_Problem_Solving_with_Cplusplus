// This is test_class_7.cpp
// Changes from test_class_6.cpp
// 1. change all return/arg types of month from int to MONTH
// 2. verify enum is stored as int internally
...
TEST_CASE("Class set year validation", "[class]")
{
  ...
  REQUIRE_THROWS_AS(Date(1500, JAN, 1), std::invalid_argument);
  REQUIRE_NOTHROW(Date(2020, JAN, 1));
}

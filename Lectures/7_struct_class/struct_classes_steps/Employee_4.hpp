// This is Employee_4.hpp
// Changes from Employee_3.hpp:
// change Date from struct to class, including header file
...
#include "Date_4.hpp" // this is needed for starting_day private attribute

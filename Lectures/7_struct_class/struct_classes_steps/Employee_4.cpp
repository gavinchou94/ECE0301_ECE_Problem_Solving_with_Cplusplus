// This is Employee_4.cpp
// Changes from Employee_3.cpp
// 1. constructor of Employee() changed to use in-line way for class type attribute
// 2. starting_day(x,y,z) version of constructor called
